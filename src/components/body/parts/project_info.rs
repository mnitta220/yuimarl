                ...
                *buf += r#"<form name="post_project" id="post_project" action="/project" method="POST">"#;
                {
                    ...
                    *buf += r#"<div class="row py-2">"#;
                    {
                        *buf +=
                            r#"<label class="col-md-3 col-form-label bg-light mb-1" for="name">"#;
                        *buf += r#"プロジェクト名</label>"#;
                    ...
                    *buf += r#"<div class="row py-2">"#;
                    {
                        *buf +=
                            r#"<label class="col-md-3 col-form-label bg-light mb-1" for="prefix">"#;
                    ...
                    *buf += r#"<div class="row py-2">"#;
                    {
                        *buf +=
                            r#"<label class="col-md-3 col-form-label bg-light mb-1" for="member">"#;
                        *buf += r#"メンバー</label>"#;
                                    ...
                                    *buf += r#"<div class="col-9">"#;
                                    {
                                        ...
                                        *buf += r#"</button>&nbsp;&nbsp;"#;
                                        ...
                                        if let Some(id) = &p.id {
                                            *buf +=
                                                r#"<a class="btn btn-primary" href="/project?id="#;
                                            *buf += id;
                                            *buf += r#"" role="button">"#;
                                            {
