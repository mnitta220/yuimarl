                                                ...
                                                *buf += r#"<div class="modal-footer">"#;
                                                {
                                                    ...
                                                    *buf += r#"data-bs-dismiss="modal">キャンセル</button> "#;
                                    ...
                                    *buf += r#"<div class="col-md-9 mb-1">"#;
                                    {
                                        *buf += r#"<div class="form-check form-check-inline">"#;
                                        {
                                            *buf += r#"<input class="form-check-input" type="radio" name="language" id="lang1" "#;
                                            *buf += r#"value="ja" checked="checked">"#;
                                            *buf += r#"<label class="form-check-label" for="lang1">日本語</label>"#;
                                        }
                                        *buf += r#"</div>"#;
                                        *buf += r#"<div class="form-check form-check-inline">"#;
                                        {
                                            *buf += r#"<input class="form-check-input" type="radio" name="language" id="lang2" "#;
                                            *buf += r#"value="en">"#;
                                            *buf += r#"<label class="form-check-label" for="lang2">英語</label>"#;
                                        }
                                        *buf += r#"</div>"#;
                                    }
                                    *buf += r#"</div>"#;
