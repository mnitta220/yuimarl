...
def test_senario1(page: Page):
    ...
    page.get_by_test_id("addMember").click()
    ...
    expect(page.get_by_test_id("toast")).to_contain_text("ノートを更新しました。")
    page.get_by_role("link", name="ホーム (current)").click()
    ...
    page.get_by_test_id("addCharge").click()
    page.locator("#check0").click()
    page.locator("#check0").check()
    page.locator("#check1").click()
    page.locator("#check1").check()
    page.locator("#check2").click()
    ...
    page.get_by_role("button", name="更新").click()
    expect(page.get_by_test_id("toast")).to_contain_text("チケットを更新しました。")
    page.get_by_role("link", name="ホーム").first.click()
