                    ...
                    *buf += r#"<div class="container">"#;
                    {
                        *buf += r#"<ol>"#;
                        {
                            *buf += r#"<li>"#;
                            *buf += r#"現在、当システムは無料で使用できますが、将来、有料化する可能性があります。"#;
                            *buf += r#"</li>"#;

                            *buf += r#"<li>"#;
                            *buf += r#"運用者（新田システム事務所）は、必要に応じて、当システムに保存されているデータを閲覧する場合があります。"#;
                            *buf += r#"</li>"#;
                            ...
                            *buf += r#"<li>"#;
                            *buf += r#"当システムにおいて、誹謗中傷や、公序良俗に反する不適切な使用などが発覚した場合は、利用者のアカウントを停止させていただく場合があります。"#;
                            *buf += r#"</li>"#;
